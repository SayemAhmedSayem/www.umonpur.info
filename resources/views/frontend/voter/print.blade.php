          ...
          <div class="col-12">
            ...
            <div class="single-voter-card">
              ...
              <div class="main-voter-info">
                <div class="voter-img">
                  <img src="{{ asset('uploads/members/'.$voter->image) }}" alt="Voter Image" style="max-width:150px;">
                </div>
                <div class="voter-info">
                  ...
                  <p><span class="name-title">নাম:</span> <span class="name">{{$voter->name_bn ?? ''}}</span></p>
                  ...
                  <p style="color:green;font-weight:bold"><span class="name-title">সিরিয়াল নং:</span> <span class="name">{{$voter->serial ?? ''}}</span></p>
                </div>
              </div>
            </div>
