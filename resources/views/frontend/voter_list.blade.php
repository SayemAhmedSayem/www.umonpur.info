  ...
  <section class="voter_list_area">
    <div class="container-md">
      ...
      <div class="voter-card">
        <div class="row">
          <div class="col-2">
            <p class="voter-card-token">সিরিয়াল নং - <span class="token"></span></p>
          </div>
        </div>
        <div class="row">
          <div class="col-12">
            ...
            <div class="single-voter-card">
              ...
              <div class="main-voter-info">
                ...
                <div class="voter-info">
                  ...
                  <p><span class="name-title">নাম:</span> <span class="name"></span></p>
                  <p><span class="name-title-en">Name:</span> <span class="name-en"></span></p>
                  <p><span class="name-title-father">পিতা:</span> <span class="name-father"></span></p>
                  <p><span class="name-title-mother">মাতা:</span> <span class="name-mother"></span></p>
                  <p><span class="birth-date-title">Date of Birth</span> <span class="date-birth"></span></p>
                  <p><span class="id-title">ID NO:</span> <span class="voter-id"></span></p>
                  <p><span class="name-title">সিরিয়াল নং:</span> <span class="name"></span></p>
                </div>
              </div>
            </div>
            <!-- Voter Card Print -->
