  ...
  <section class="post-banner-area banner-section" style="background-image: url({{asset('frontend/assets/img/blog1.jpg')}});">
    <div class="container">
      <div class="banner-title">
        <h2><span> Donation Checkout Page</span></h2>
        <!-- <p class="banner-title-desc">গাইবান্ধার বালাসী থেকে জামালপুরের বাহাদুরাবাদ নৌরুটে এক মাস আগে লঞ্চ পারাপারের
          ...
          তিনটি লঞ্চ রয়েছে</p> -->
        <p><a href="index.html">হোম</a> <i class="fa fa-angle-right"></i> <span>Donation Checkout Page</span></p>
      </div>
    </div>
  </section>
    ...
    <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                <span class="text-muted">Donation Details</span>
            ...
            <form method="POST" class="needs-validation" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="customer_email" class="form-control" id="email"
                           placeholder="you@example.com" value="{{$user->name}}" required>
                    <div class="invalid-feedback">
