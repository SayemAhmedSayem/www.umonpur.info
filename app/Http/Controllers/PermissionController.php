...
class PermissionController extends Controller
{
	...
	public function store(Request $request){
		...
		return redirect()->route('permission.index', $request->role_id)->with('success', ('Saved Sucessfully'));
	...
	// return 'yes';
		return view('backend.permission.modal.create', compact('permission', 'permission_list', 'role_id'));
	}
