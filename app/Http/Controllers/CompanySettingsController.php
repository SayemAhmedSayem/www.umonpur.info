...
class CompanySettingsController extends Controller {
    public function index(){
        $data['types'] = Item::where('company_id', company_id())
        ->where('item_type', 'service')
        ->get();
        return view('settings.business_information.index', $data); 
       }
    ...
    public function invoice(){
        return view('settings.business_information.invoice');
       }
    public function invoicesettings($store = "", Request $request) {
    ...
    public function paymentsettings(Request $request) {
        ...
        if ($store == "") {
            return view('settings.business_information.payment');
        } else {
            ...
            return redirect()->route('company.payment_settings')->with('success', _lang('Saved Sucessfully'));
